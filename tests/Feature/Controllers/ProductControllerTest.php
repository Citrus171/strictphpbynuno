...
it('searchパラメータを指定した時、検索が適用されること', function (): void {
    Product::factory()->create(['status' => 'published', 'attribute_data' => collect(['name' => new Lunar\FieldTypes\Text('Nike Shoes')])]);
    Product::factory()->create(['status' => 'published', 'attribute_data' => collect(['name' => new Lunar\FieldTypes\Text('Adidas Shoes')])]);
    Product::factory()->create(['status' => 'published', 'attribute_data' => collect(['name' => new Lunar\FieldTypes\Text('Nike T-Shirt')])]);
